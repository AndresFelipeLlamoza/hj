		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse justify-content-end" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item selector">
						<a class="nav-link selector" style="color:black;" href="/hj/view/mision.php">Misión/Visión</a>
					</li>
					<li class="nav-item cs">
						<a class="nav-link selector" style="color:red;" href="/hj/view/login.php">Acceder</a>
					</li>
				</ul>
			</div>
		</div>
